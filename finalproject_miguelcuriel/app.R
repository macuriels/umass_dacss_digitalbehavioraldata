...
ui <- fluidPage(
  ...
  ,p(class = 'text-muted'
     ,paste('This dashboard is created to explore digital trends related to Netflix. 
            Each tab below represents the different sources utilized. Google Trends data is downloaded via the gtrendsR package in R, the keywords "netflix", "disney plus", "prime video", "hbo max" and "hulu" were used and the timeframe is Oct/01/2022 - Dec/07/2022. This data is utilized to assess the popularity of each contrast account as well as understand queries associated to Netflix.
            From Twitter, tweets containing "#netflix" are downloaded using the rtweet package in R, resulting in a timespan of Dec/04/2022 - Dec/07/2022 and in 9886 tweets, of which 211 have a geocode. This data is utilized to create a world map visualizing the tweets as well as a hashtag network.'))
